...
{
    public abstract class SalesManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SalesManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SalesManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SalesManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SalesManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SalesManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SalesManagementDbContext, Task<T>> func)
        {
            T result;
