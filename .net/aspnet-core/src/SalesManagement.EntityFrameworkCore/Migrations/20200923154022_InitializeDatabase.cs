        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainBroad = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    CpuInfor = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(nullable: true),
                    Price = table.Column<long>(nullable: false),
                    Gurantee = table.Column<long>(nullable: false),
                    Total = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupRam = table.Column<string>(nullable: true),
                    ImageString = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    Price = table.Column<long>(nullable: false),
                    Total = table.Column<long>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainBroads", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainBroad = table.Column<string>(nullable: true),
                    Hhd = table.Column<string>(nullable: true),
                    ...
                    KeyBroad = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    Price = table.Column<long>(nullable: false),
                    Gurantee = table.Column<long>(nullable: false),
                    Total = table.Column<long>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nand = table.Column<string>(nullable: true),
                    ImageString = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    Price = table.Column<long>(nullable: false),
                    Gurantee = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GpuClock = table.Column<string>(nullable: true),
                    ImageString = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    Price = table.Column<long>(nullable: false),
                    Gurantee = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoGraphicsArrays", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductConfigurationId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Products_ProductConfigurations_ProductConfigurationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RamId = table.Column<long>(nullable: true),
                    CaseId = table.Column<long>(nullable: true),
                    VideoGraphicsArrayId = table.Column<long>(nullable: true),
                    CpuId = table.Column<long>(nullable: true),
                    MainBroadId = table.Column<long>(nullable: true),
                    SolidStateDriveId = table.Column<long>(nullable: true),
                    HardDiskDriveId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItems_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_Cpus_CpuId",
                        column: x => x.CpuId,
                        principalTable: "Cpus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_HardDiskDrives_HardDiskDriveId",
                        column: x => x.HardDiskDriveId,
                        principalTable: "HardDiskDrives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_MainBroads_MainBroadId",
                        column: x => x.MainBroadId,
                        principalTable: "MainBroads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_Rams_RamId",
                        column: x => x.RamId,
                        principalTable: "Rams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_SolidStateDrives_SolidStateDriveId",
                        column: x => x.SolidStateDriveId,
                        principalTable: "SolidStateDrives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_VideoGraphicsArrays_VideoGraphicsArrayId",
                        column: x => x.VideoGraphicsArrayId,
                        principalTable: "VideoGraphicsArrays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_CaseId",
                table: "OrderItems",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_CpuId",
                table: "OrderItems",
                column: "CpuId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_HardDiskDriveId",
                table: "OrderItems",
                column: "HardDiskDriveId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_MainBroadId",
                table: "OrderItems",
                column: "MainBroadId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_RamId",
                table: "OrderItems",
                column: "RamId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_SolidStateDriveId",
                table: "OrderItems",
                column: "SolidStateDriveId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_VideoGraphicsArrayId",
                table: "OrderItems",
                column: "VideoGraphicsArrayId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductConfigurationId",
                table: "Products",
